...
void keyPressed() {
  ...
  if (key == ' ') {
    //fire a shot
    missiles.add(new Missile(0, 0, rotated));  //Adds a missile to the arraylist missiles. 0,-10 makes them appear from the point of the ship. Rotated is the angle they are supposed to fire.
